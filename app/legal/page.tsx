      ...
      <div className="max-w-5xl mx-auto px-4">
          ...
          <div className="p-6">
            ...
            {activeTab === "terms" && (
              <div className="animate-fadeIn">
                ...
                <p className="text-gray-600 mb-4">
                  By accessing or using MCPH's file-sharing service, you agree
                  to be bound by these Terms of Service. If you disagree with
                  any part of the terms, you do not have permission to access or
                  use our service.
                </p>
            ...
            {activeTab === "about" && (
              <div className="animate-fadeIn">
                ...
                <ul className="list-disc pl-6 text-gray-600 space-y-2 mb-6">
                  <li>
                    <strong>Frontend:</strong> Next.js with TypeScript and React
                  </li>
                  <li>
                    <strong>Storage:</strong> Google Cloud Storage with
                    automatic lifecycle management
                  </li>
                  <li>
                    <strong>Security:</strong> Encryption at rest and in transit
                  </li>
                  <li>
        ...
        <div className="bg-white rounded-lg shadow-sm p-6 mb-8">
          ...
          <p className="text-gray-600 mb-4">
            ...
            Service, or anything else, please contact us:
          </p>
