      ...
      <section className="py-12 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-3xl font-bold mb-3 text-gray-800">
            AI-First Crate Storing & Sharing
          </h1>
          <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
            Store and share crates—AI-first. Connect tools like ChatGPT or
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="bg-white rounded p-4 border border-gray-200">
              ...
              <p className="text-gray-600 text-sm">
                Designed for seamless AI workflows. Store and retrieve crates
            ...
            <div className="bg-white rounded p-4 border border-gray-200">
              ...
              <p className="text-gray-600 text-sm">
                ...
                account needed to access shared crates.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex flex-wrap justify-center mb-6">
            ...
            <div className="flex items-center mx-4 mb-4">
              ...
              <span className="text-gray-700">
                Store and share crates directly from your AI
              </span>
            </div>
          </div>
        </div>
