      ...
      <section className="relative isolate overflow-hidden py-10 md:py-16 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex flex-wrap justify-center gap-2 md:gap-3 mt-6">
            ...
            <span className="inline-flex items-center px-2 md:px-3 py-1 rounded-full border border-orange-200 bg-orange-50 text-xs md:text-sm text-gray-700">
              <FaCheck className="text-green-500 mr-1.5 text-xs" /> 30-day auto-expiry
            </span>
            <span className="inline-flex items-center px-2 md:px-3 py-1 rounded-full border border-orange-200 bg-orange-50 text-xs md:text-sm text-gray-700">
              <FaCheck className="text-green-500 mr-1.5 text-xs" /> Up to 10 MB
            </span>
            <span className="inline-flex items-center px-2 md:px-3 py-1 rounded-full border border-orange-200 bg-orange-50 text-xs md:text-sm text-gray-700">
              <FaCheck className="text-green-500 mr-1.5 text-xs" /> Password-optional
            </span>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 md:gap-6">
            <div className="bg-white rounded-xl p-4 md:p-6 shadow-sm border border-gray-200 transition-all duration-300 hover:shadow-md hover:translate-y-[-2px]">
              ...
              <h3 className="font-medium mb-2 md:mb-3 text-center text-gray-800 text-base md:text-lg">Upload</h3>
            ...
            <div className="bg-white rounded-xl p-4 md:p-6 shadow-sm border border-gray-200 transition-all duration-300 hover:shadow-md hover:translate-y-[-2px]">
              ...
              <h3 className="font-medium mb-2 md:mb-3 text-center text-gray-800 text-base md:text-lg">Share</h3>
              <p className="text-gray-600 text-center text-sm md:text-base">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="relative flex flex-col md:flex-row items-center justify-between gap-4 py-6">
            ...
            <div className="bg-green-50 border border-green-200 rounded-xl p-5 shadow-sm w-full md:w-64 text-center">
              ...
              <p className="text-sm text-gray-600">Creates content for sharing</p>
            </div>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-xl p-5 shadow-sm w-full md:w-64 text-center">
              ...
              <p className="text-sm text-gray-600">Access content without login</p>
            </div>
          ...
          <div className="mt-8 text-center">
            <p className="text-gray-600 max-w-xl mx-auto">
              Share AI-generated content with a single link that works for both humans and AI agents. No authentication required for viewing.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex flex-wrap justify-center items-center gap-8 md:gap-12">
            ...
            <div className="grayscale opacity-60 hover:grayscale-0 hover:opacity-100 transition-all duration-300">
              <svg className="h-8 w-auto" viewBox="0 0 120 30" fill="currentColor">
                <rect x="10" y="8" width="100" height="15" rx="4" fill="#4B5563" />
                <text x="60" y="19" fontSize="10" fill="white" textAnchor="middle">AI STARTUP</text>
              </svg>
            </div>
            ...
            <div className="grayscale opacity-60 hover:grayscale-0 hover:opacity-100 transition-all duration-300">
              <svg className="h-7 w-auto" viewBox="0 0 120 30" fill="currentColor">
                ...
                <rect x="35" y="8" width="75" height="15" rx="2" fill="#4B5563" />
                <text x="73" y="19" fontSize="9" fill="white" textAnchor="middle">RESEARCH LAB</text>
              </svg>
            </div>
            ...
            <div className="grayscale opacity-60 hover:grayscale-0 hover:opacity-100 transition-all duration-300">
              <svg className="h-8 w-auto" viewBox="0 0 120 30" fill="currentColor">
                ...
                <rect x="55" y="8" width="55" height="15" rx="3" fill="#4B5563" />
                <text x="83" y="19" fontSize="8" fill="white" textAnchor="middle">TECH COMPANY</text>
              </svg>
            </div>
            
            <div className="grayscale opacity-60 hover:grayscale-0 hover:opacity-100 transition-all duration-300">
              <svg className="h-6 w-auto" viewBox="0 0 120 30" fill="currentColor">
                <rect x="10" y="5" width="100" height="20" rx="10" fill="#4B5563" />
                <text x="60" y="19" fontSize="10" fill="white" textAnchor="middle">ENTERPRISE CO</text>
              </svg>
            </div>
          </div>
          ...
          <div className="mt-12 bg-white p-6 rounded-xl shadow-sm border border-gray-200">
            <p className="italic text-gray-600 text-center">
              "MCPHub has transformed how our AI services share information with users. The streamlined process and instant sharing have significantly improved our user experience."
            </p>
            <div className="mt-4 text-center">
              <p className="font-medium text-gray-800">Alex Chen</p>
              <p className="text-sm text-gray-500">AI Product Manager at TechCorp</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-4">
            <div className="bg-white p-5 rounded-xl text-center shadow-sm border border-gray-200 hover:shadow-md hover:border-orange-200 transition-all duration-300">
              <div className="text-orange-500 mb-3">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 mx-auto" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            <div className="bg-white p-5 rounded-xl text-center shadow-sm border border-gray-200 hover:shadow-md hover:border-orange-200 transition-all duration-300">
              ...
              <span className="inline-block mt-2 text-xs px-2 py-1 bg-purple-100 text-purple-700 rounded-full">New!</span>
              <p className="text-xs text-gray-500 mt-1">PDFs, images, and more</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-gradient-to-br from-orange-50 to-orange-100 rounded-xl p-8 shadow-md border border-orange-200 relative hover:shadow-lg transition-all duration-300">
              ...
              <div className="text-center mb-6">
                ...
                <p className="text-3xl font-bold text-gray-800 mt-4">$9<span className="text-lg font-normal">/mo</span></p>
              ...
              <ul className="space-y-3 mb-8">
                <li className="flex items-start">
                  ...
                  <span className="text-gray-700"><strong>100MB</strong> file size limit</span>
                </li>
                <li className="flex items-start">
                  <svg className="h-5 w-5 text-green-500 mr-2 mt-0.5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                  </svg>
                  <span className="text-gray-700"><strong>1-year</strong> link expiry</span>
                </li>
                <li className="flex items-start">
                  <svg className="h-5 w-5 text-green-500 mr-2 mt-0.5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
