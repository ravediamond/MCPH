        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="bg-white border border-gray-200 rounded-lg overflow-hidden shadow-sm transform transition-transform hover:shadow-md hover:-translate-y-1">
            <div className="p-6 border-b border-gray-200">
              ...
              <p className="text-gray-600">
                Complete API documentation for uploading, downloading, and
                managing files through our REST endpoints.
              </p>
            </div>
          ...
          <div className="bg-white border border-gray-200 rounded-lg overflow-hidden shadow-sm transform transition-transform hover:shadow-md hover:-translate-y-1">
            <div className="p-6 border-b border-gray-200">
              ...
              <p className="text-gray-600">
                Learn how to use MCPH with Model Context Protocol for AI
                integrations and LLM file management.
              </p>
            </div>
            <div className="bg-gray-50 px-6 py-3">
              <Link
          ...
          <div className="bg-white border border-gray-200 rounded-lg overflow-hidden shadow-sm transform transition-transform hover:shadow-md hover:-translate-y-1">
            <div className="p-6 border-b border-gray-200">
              ...
              <p className="text-gray-600">
                Frequently asked questions about MCPH's services, usage limits,
        ...
        <div className="mt-12 bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            >
              ...
              <p className="text-sm text-gray-600">
                AI integrations with Server-Sent Events
              </p>
            </Link>
