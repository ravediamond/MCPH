      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
            ...
            <div className="border border-gray-200 rounded-lg p-3">
              <h4 className="font-medium text-gray-800 mb-1">Diagrams</h4>
              <p className="text-sm text-gray-600">
                Share flowcharts, sequence diagrams, ER diagrams and more using
                Mermaid syntax. Diagrams render as interactive SVGs.
              </p>
            </div>
            ...
            <div className="border border-gray-200 rounded-lg p-3">
              <h4 className="font-medium text-gray-800 mb-1">To-Do Lists</h4>
              <p className="text-sm text-gray-600">
                Share task lists and checklists in an interactive format. Great
                for project plans and action items generated by AI.
              </p>
            </div>

            <div className="border border-gray-200 rounded-lg p-3">
              <h4 className="font-medium text-gray-800 mb-1">JSON/Data</h4>
              <p className="text-sm text-gray-600">
          ...
          <div className="space-y-4 mb-6">
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">
                  All crates have an automatic expiration date. You can choose
                  between 1 day and up to 1 year. After expiration, the content
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">
                  ...
                  the provided iframe code. Great for including diagrams or code
                  snippets in documentation or blog posts.
                </p>
              </div>
            </div>
          </div>
