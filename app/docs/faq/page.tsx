          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-lg text-gray-700">
                ...
                standardizes how applications provide context to Large Language
                Models (LLMs). It allows LLMs to safely access external data
            ...
            <div>
              ...
              <p className="text-lg text-gray-700">
                MCPH is a platform for discovering, sharing, and using MCP
                implementations. It serves as a central registry for MCP servers
                that enable AI models to interact with various data sources and
                tools.
              </p>
            </div>
        ...
        <section className="border-b border-gray-200 pb-6">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <p className="text-lg text-gray-700">
                Yes, you can connect multiple MCPs to your AI application,
                allowing it to access various capabilities and data sources
                simultaneously.
              </p>
            </div>
          </div>
        ...
        <section>
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-lg text-gray-700">To publish your MCP:</p>
              <ol className="list-decimal pl-6 mt-3 space-y-2 text-lg text-gray-700">
