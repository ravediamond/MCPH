...
async function setAdminClaimForUser(uid: string) { // Renamed function
    if (!uid) {
    ...
    try {
        ...
        console.log('The user may need to sign out and sign back in, or their ID token refreshed, for the changes to take effect immediately on the client-side.');
