...
const useCases = [
  {
    ...
    description:
      "Generate a link for any file or note—right from ChatGPT, Claude, or your favorite AI tool.",
    image: "/icon.png",
  },
  {
    title: "Reuse Notes Across Chats",
    description:
      "Save important info and pull it up in any conversation, any time.",
    image: "/icon.png",
  },
  {
  ...
  },
  {
    ...
    description:
      "Upload once, access from any AI assistant—no more re-uploading.",
    image: "/icon.png",
  },
  {
    title: "Store Metrics for Experiments",
    description:
      "Keep track of results, logs, or metrics for your AI projects and experiments.",
    image: "/icon.png",
  },
  {
    title: "Long-Term AI Memory",
    description:
      "Build a persistent memory for your AI—store facts, context, or reminders for future use.",
    image: "/icon.png",
  },
];
